...
class FirstLastPage:
    ...
    def extract_last_page_details(self, img):
        result = OrderedDict()
        coordinates = [
            [x * self.rescale for x in [2504, 988, 1200,95]],
            [x * self.rescale for x in [2494, 2486, 1200, 95]],
            [x * self.rescale for x in [2494, 2516, 1200, 95]]
        ]
    ...
    def extract_first_page_details(self, img):
        ...
        a,b,c,d = [ x * self.rescale for x in [1770, 1900, 1480, 545]] # mandal block
        ...
        a,b,c,d = [ x * self.rescale for x in [3165, 295, 620, 190]]  # part no
        ...
        a,b,c,d = [ x * self.rescale for x in [185, 3330, 2000, 672]] # police name name and address
        ...
        a,b,c,d = [ x * self.rescale for x in [180, 290, 2806, 405]]# ac name and parl
